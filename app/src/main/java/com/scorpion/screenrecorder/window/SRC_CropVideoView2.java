...
public class SRC_CropVideoView2 extends FrameLayout {
    private VideoView mPlayerView;
    private SRC_CropView mCropView;
    ...
    public SRC_CropVideoView2(Context context) {
        super(context);
        init(context);
    }

    public SRC_CropVideoView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context) {
        ...
        View v = inflater.inflate(R.layout.src_view_crop2, this, true);
