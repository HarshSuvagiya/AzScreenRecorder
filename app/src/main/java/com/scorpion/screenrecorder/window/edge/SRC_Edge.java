...
public enum SRC_Edge {
    ...
    public void adjustCoordinate(float aspectRatio) {
        ...
        switch(this) {
            case LEFT:
                this.mCoordinate = SRC_AspectRatioUtil.calculateLeft(top, right, bottom, aspectRatio);
                break;
            case TOP:
                this.mCoordinate = SRC_AspectRatioUtil.calculateTop(left, right, bottom, aspectRatio);
                break;
            case RIGHT:
                this.mCoordinate = SRC_AspectRatioUtil.calculateRight(left, top, bottom, aspectRatio);
                break;
            case BOTTOM:
                this.mCoordinate = SRC_AspectRatioUtil.calculateBottom(left, top, right, aspectRatio);
        }

    }

    public boolean isNewRectangleOutOfBounds(SRC_Edge edge, Rect imageRect, float aspectRatio) {
        ...
        switch(this) {
            case LEFT:
                if (edge.equals(TOP)) {
                    ...
                    bottom = SRC_AspectRatioUtil.calculateLeft(right, top, left, aspectRatio);
                ...
                if (edge.equals(BOTTOM)) {
                    ...
                    top = RIGHT.getCoordinate();
                    bottom = SRC_AspectRatioUtil.calculateLeft(left, top, right, aspectRatio);
            ...
            case TOP:
                if (edge.equals(LEFT)) {
                    ...
                    bottom = SRC_AspectRatioUtil.calculateTop(right, left, top, aspectRatio);
                ...
                if (edge.equals(RIGHT)) {
                    ...
                    top = BOTTOM.getCoordinate();
                    bottom = SRC_AspectRatioUtil.calculateTop(left, right, top, aspectRatio);
            ...
            case RIGHT:
                if (edge.equals(TOP)) {
                    ...
                    bottom = SRC_AspectRatioUtil.calculateRight(top, right, left, aspectRatio);
                ...
                if (edge.equals(BOTTOM)) {
                    ...
                    left = TOP.getCoordinate() - offset;
                    top = LEFT.getCoordinate();
                    bottom = SRC_AspectRatioUtil.calculateRight(top, left, right, aspectRatio);
            ...
            case BOTTOM:
                if (edge.equals(LEFT)) {
                    ...
                    bottom = SRC_AspectRatioUtil.calculateBottom(right, top, left, aspectRatio);
                ...
                if (edge.equals(RIGHT)) {
                    ...
                    left = LEFT.getCoordinate() - offset;
                    top = TOP.getCoordinate();
                    bottom = SRC_AspectRatioUtil.calculateBottom(left, top, right, aspectRatio);
