...
public class SRC_CropVideoView extends FrameLayout {
    ...
    public SRC_CropVideoView(Context context) {
        super(context);
        init(context);
    }

    public SRC_CropVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context) {
        ...
        View v = inflater.inflate(R.layout.src_view_crop, this, true);
